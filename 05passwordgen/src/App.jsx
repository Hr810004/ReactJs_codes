import { useState, useCallback,useEffect, useInsertionEffect } from 'react'
import './App.css'
    ...
    <>
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-4 my-8 text-black-500 bg-gray-600">
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          <input type="text" value={password} placeholder='password' className='bg-white px-3 py-1 outline-none w-full text-black' readOnly />
          <button className='px-3 text-white cursor-pointer bg-black pb-1'>Copy</button>
        </div>
